        ...
        <div className="blog__items dflex">
          <div className="blog__item col-2-5 wow" data-animate="fadeInLeft">
            <div className="blog__image">
              <img
                src="http://cheaphostings.org/html/item-lalvai/lalvai/assets/img/blog/1.jpg"
                alt="test"
              />
              <div className="blog__overlay">Marketinig</div>
            </div>
            <div className="blog__content">
              <a className="date" href="google.com">
              ...
              <a className="heading" href="google.com">
              ...
              <a className="read" href="google.com">
                Read More
              </a>
            </div>
          </div>
